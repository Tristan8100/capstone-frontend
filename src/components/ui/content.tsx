...
export default function ContentSection() {
    return (
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-[1200px] space-y-8 px-6 md:space-y-16">
                ...
                <div className="relative">
                    <div className="relative ml-[50px] lg:ml-[50px] z-10 space-y-4 md:w-1/2">
                    ...
                    <div className="mt-12 h-fit md:absolute md:-inset-y-12 md:inset-x-0 md:mt-0">
                        ...
                        <div className="border-border/50 relative rounded-2xl border border-dotted p-2">
                            <img src="static/alumni.jpg" className="hidden rounded-[12px] dark:block" alt="payments illustration dark" width={1207} height={929} />
                            <img src="static/alumni.jpg" className="rounded-[12px] shadow dark:hidden" alt="payments illustration light" width={1207} height={929} />
                        </div>
                    </div>
                </div>
            </div>
